...
---------------------------------------------------------------------------------
## CC, IP & PROMISE: 
WHATEREVER IS WRITTTEN IS INTELLECTUAL PROPERTY OF EE, SHA, FTL, U, RI [ENGINEERS ECHELON, SHASTRARTHA, FREEDOM TO LIBERTY, UNBIASED & RETALIATOR IMMORTAL]. IF YOU ARE USING THE IDEAS FOR TEACHING THEN JUST GIVE CREDIT BUT IF YOU ARE MAKING PROFIT FROM IT THEN SIGN A CONTRACT WITH GOBOT.
